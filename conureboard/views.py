...
def show_services():
  ...
  #base services query
  services = session.query(models.Service, models.Status).\
              join(models.Status).\
              with_entities(models.Service.name, models.Service.host, models.Service.status, models.Service.modify_date, models.Service.start_date,\
                models.Service.stop_date, models.Service.message, models.Service.arguments, models.Status.description, models.Status.id )
  ...
  if request.args.get('sort_by'):
    if request.args.get('sort_order') == 'desc':
      ...
      services = services.order_by(getattr(models.Service, request.args.get('sort_by')))
  else:
    #default sort
